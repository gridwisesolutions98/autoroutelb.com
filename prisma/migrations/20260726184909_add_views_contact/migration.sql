...
INSERT INTO "new_Car" ("category", "createdAt", "id", "image", "isApproved", "isRented", "name", "pricePerDay", "seats", "transmission", "vendorId") SELECT "category", "createdAt", "id", "image", "isApproved", "isRented", "name", "pricePerDay", "seats", "transmission", "vendorId" FROM "Car";
DROP TABLE "Car";
